package com.salgu.salguauth.util;
...
public class AopLogger {
    ...
    @Pointcut("within(com.salgu.salguauth.*.controller..*)") // 3
    public void onRequest() {
    }

    @Pointcut("within(com.salgu.salguauth.util.exception.GlobalExceptionHandler)") // 3
    public void onErrorRequest() {
    }

    @Around("com.salgu.salguauth.util.AopLogger.onRequest() || com.salgu.salguauth.util.AopLogger.onErrorRequest()") // 4
